...
GOOGLE_CLIENT_ID = "210796799528-lp0ggmjbcd1uvg5m177s8p4qm4226cjp.apps.googleusercontent.com"
...
##app.config['MONGO_URI']= 'mongodb+srv://admin:admin@cluster0.tohc9da.mongodb.net/ResumeRanking'
app.config['MONGO_URI'] = 'mongodb://atlas-sql-65ce61c502e7c10393c3116c-zamul.a.query.mongodb.net/ResumeRanking?ssl=true&authSource=admin'
...
def empSearch():
    if request.method == 'POST':
        ...
        TopEmployeers = Applied_EMP.find({"job_id": {"$in": job_ids}},{"user_id": 1, "Matching_percentage": 1, "Resume_name": 1}).sort([("Matching_percentage", -1)])
        # print(TopEmployeers)
    ...
    #############
    result = resumeFetchedData.find({"UserId":ObjectId(se['_id'])})     
    dt=result[0]
    name_resume=dt['Name']
    if name_resume is not None:
        name = name_resume
    ...
    selectedResumes[cnt] = {"Name":se['Name'],"Email":se['Email'],"_id":se['_id'], "Resume_name": i['Resume_name'], "Matching_percentage": i["Matching_percentage"]}
    se = None
    cnt += 1
